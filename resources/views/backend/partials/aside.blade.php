        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{url('/all_category')}}" class="nav-link">
          ...
          <li class="nav-item">
            <a href="{{url('/view_brands')}}" class="nav-link">
              <i class="nav-icon fab fa-bandcamp text-info"></i>
              <p>
                Brands
                <span class="badge badge-info right">2</span>
              </p>
          ...
          <li class="nav-item has-treeview">
            <a href="{{url('/view_sliders')}}" class="nav-link">
                <i class="nav-icon fas fa-sliders-h text-success"></i>
              <p>
                Slider
                {{-- <i class="fas fa-angle-left right"></i> --}}
              </p>
          ...
          <li class="nav-item">
            <a href="pages/gallery.html" class="nav-link">
              <i class="nav-icon fas fa-male text-danger"></i>
              <p>
                Delivery Man
              </p>
            </a>
